...
/**
 * phoneui_call_management_override_properties:
 * @klass: The class structure for a #GObject<!-- -->-derived class.
 * @property_id_begin: The property id to assign to the first overridden property.
 *
 * Overrides all #GObject properties in the #PhoneuiCallManagement interface for a concrete class.
 * The properties are overridden in the order they are defined.
 *
 * Returns: The last property id.
 */
guint
phoneui_call_management_override_properties (GObjectClass *klass, guint property_id_begin)
{
...
phoneui_call_management_default_init (PhoneuiCallManagementIface *iface)
{
   ...
   * @arg_call_id: Argument passed by remote caller.
 ...
 * @arg_call_id: Argument to pass with the method invocation.
...
struct _PhoneuiCallManagementProxyPrivate
{
  GData *qdata;
};

static void phoneui_call_management_proxy_iface_init (PhoneuiCallManagementIface *iface);
...
static void
phoneui_call_management_proxy_finalize (GObject *object)
{
  PhoneuiCallManagementProxy *proxy = PHONEUI_CALL_MANAGEMENT_PROXY (object);
  g_datalist_clear (&proxy->priv->qdata);
  G_OBJECT_CLASS (phoneui_call_management_proxy_parent_class)->finalize (object);
}
...
static void
phoneui_call_management_proxy_g_properties_changed (GDBusProxy *_proxy,
  GVariant *changed_properties,
  const gchar *const *invalidated_properties)
{
  PhoneuiCallManagementProxy *proxy = PHONEUI_CALL_MANAGEMENT_PROXY (_proxy);
  guint n;
  const gchar *key;
  GVariantIter *iter;
...
{
  proxy->priv = G_TYPE_INSTANCE_GET_PRIVATE (proxy, TYPE_PHONEUI_CALL_MANAGEMENT_PROXY, PhoneuiCallManagementProxyPrivate);
...
phoneui_call_management_proxy_class_init (PhoneuiCallManagementProxyClass *klass)
{
  ...
  g_type_class_add_private (klass, sizeof (PhoneuiCallManagementProxyPrivate));

  gobject_class = G_OBJECT_CLASS (klass);
  gobject_class->finalize     = phoneui_call_management_proxy_finalize;
  ...
  gpointer user_data)
{
  ...
  n = 0;
  g_value_init (&paramv[n], TYPE_PHONEUI_CALL_MANAGEMENT);
...
static void phoneui_call_management_skeleton_iface_init (PhoneuiCallManagementIface *iface);
